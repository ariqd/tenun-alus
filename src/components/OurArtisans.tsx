      ...
      <div className="container px-4 mx-auto">
        <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
          <div className="relative">
            ...
            />
            <div className="absolute max-w-xs p-6 bg-white rounded-lg shadow-lg -bottom-6 -right-6">
              <p className="mb-2 text-4xl font-medium text-amber-700">25+</p>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6 pt-6">
              <div className="p-6 bg-white rounded-lg shadow-sm">
                <p className="mb-2 text-2xl font-medium text-amber-700">Global</p>
                <p className="text-gray-600">Market Expansion</p>
              </div>
              <div className="p-6 bg-white rounded-lg shadow-sm">
                <p className="mb-2 text-2xl font-medium text-amber-700">Cultural</p>
